/* 
   ...
   Author: Zongrui Liu
   Usage: JavaScript for the registration page, including user registration,
   form validation, error and toast messages, backend registration request,
   fallback localStorage registration, and Enter key support.
*/
  ...
  fetch("include/register.php", {
    ...
    .catch(() => {
      ...
      localStorage.setItem(
        "breakout_user",
        JSON.stringify({ id: newUser.id, username }),
      );
      showToast("Account created!");
      setTimeout(() => (window.location.href = "game.html"), 800);
    });
