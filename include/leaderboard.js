/* 
   ...
   Author: Tony Baxter
   Usage: JavaScript for the leaderboard page, including loading leaderboard
   data from the backend or localStorage, rendering ranked scores, highlighting
   the current user, and updating the navigation login/logout link.
*/
...
function loadLeaderboard() {
  ...
  fetch("include/leaderboard.php")
    ...
    .catch(() => {
      ...
      const lb = JSON.parse(
        localStorage.getItem("breakout_leaderboard") || "[]",
      );
