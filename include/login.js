/* 
   ...
   Author: Zongrui Liu
   Usage: JavaScript for the login page, including user login, error and toast
   messages, localStorage session handling, backend login request, fallback
   localStorage authentication, and Enter key support.
*/
